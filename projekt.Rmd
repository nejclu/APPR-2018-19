...
kable(head(tidy_life.expectancy), align="ccc", col.names = c("Država", "Leto", "Pričakovana življenjska doba"))
```   
...
kable(head(tidy_trust), align="ccc", col.names = c("Država", "Leto", "(Odsotnost) korupcije"))
```     
...
kable(head(tidy_residual), align="ccc", col.names = c("Država", "Leto", "Dystopia in preostanek"))
```     
