...
Prvi graf predstavlja stopnjo sreče po državah, ki so razdeljene po celinah.

```{r graf2, echo=FALSE, message=FALSE, warning=FALSE}
print(graf2)
```

Pri drugem grafu sem iskal kolikšna je korelacija med stopnjo sreče v državi in posameznimi dejavniki. Iz grafa vidimo, da gospodarsko stanje države, pričakovana življenjska doba in družina igrajo največjo vlogo pri stopnji sreče prebivalcev posamezne države.
